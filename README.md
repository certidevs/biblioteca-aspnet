...
- Favoritos y compras de libros para usuarios autenticados.
- Reseñas de 1 a 5 estrellas; cada usuario puede modificar o borrar sus reseñas y el admin puede moderarlas.
- Perfil con favoritos, compras, reseñas y total gastado.
...
Models/          # Author, Book, Category, Review, Purchase y ApplicationUser
